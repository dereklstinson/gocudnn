...
func (handle *Handle) ActivationForward(aD ActivationD, alpha CScaler, xD TensorD, x Memer, beta CScaler, yD TensorD, yrtn Memer) error {
...
func (handle *Handle) ActivationBackward(aD ActivationD, alpha CScaler, yD TensorD, y Memer, dyD TensorD, dy Memer, xD TensorD, x Memer, beta CScaler, dxD TensorD, dx Memer) error {
