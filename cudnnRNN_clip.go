...
func (r *RNND) SetClip(h *Handle, mode RNNClipMode, nanprop PropagationNAN, lclip, rclip float64) error {
...
func (r *RNND) GetClip(h *Handle) (mode RNNClipMode, nanprop PropagationNAN, lclip, rclip float64, err error) {
	var (
