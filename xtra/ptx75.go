...
)
{
	...
	ld.param.u32 	%r41, [ShapetoBatch4DNCHW_param_0];
	ld.param.u32 	%r42, [ShapetoBatch4DNCHW_param_1];
	ld.param.u32 	%r43, [ShapetoBatch4DNCHW_param_2];
	ld.param.u32 	%r44, [ShapetoBatch4DNCHW_param_3];
	ld.param.u32 	%r45, [ShapetoBatch4DNCHW_param_4];
	ld.param.u32 	%r46, [ShapetoBatch4DNCHW_param_5];
	ld.param.u32 	%r47, [ShapetoBatch4DNCHW_param_6];
	ld.param.u32 	%r48, [ShapetoBatch4DNCHW_param_7];
	ld.param.u32 	%r49, [ShapetoBatch4DNCHW_param_8];
	ld.param.u32 	%r50, [ShapetoBatch4DNCHW_param_9];
	ld.param.u32 	%r51, [ShapetoBatch4DNCHW_param_10];
	ld.param.u32 	%r52, [ShapetoBatch4DNCHW_param_11];
	ld.param.u64 	%rd5, [ShapetoBatch4DNCHW_param_12];
	ld.param.u64 	%rd6, [ShapetoBatch4DNCHW_param_13];
	ld.param.u32 	%r53, [ShapetoBatch4DNCHW_param_14];
	ld.param.u32 	%r54, [ShapetoBatch4DNCHW_param_15];
